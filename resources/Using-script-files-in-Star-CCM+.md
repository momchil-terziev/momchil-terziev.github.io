...
-	Go to your home on the file explorer, eg: `/users/abc12345` and create a new folder. Make sure there are no spaces in the name of the folder; eg `StarccmFolder`; paste your files there.
