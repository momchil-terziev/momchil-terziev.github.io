...
public class setupyplus extends StarMacro {
  ...
  private void execute0() {
    ...
    scalarGlobalParameter_11.getQuantity().setDefinition("${U}*${rhp}*${L}/${miu}");
    ...
    scalarGlobalParameter_10.getQuantity().setDefinition("sqrt({t_w Zeng}/${rhp");
    ...
    scalarGlobalParameter_17.getQuantity().setDefinition("log(");
